...
- When the camera stops moving, the rendering starts. **This is what you should see after some rendering** by running `Engine::loadDemoScene();` at the top of `mainLoop()`:
